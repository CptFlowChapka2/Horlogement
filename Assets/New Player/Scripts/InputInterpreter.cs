    ...
    public void InterpretMoove(actionState actionType)
    {
        ...
        switch (actionType,context.groundedType)
        {
            ...
            case (actionState.pressed,groundedType.IsOnGear):
               ...
               gearAction.TransferRotation(context.currentGear,gameObject,inputReader.horizontalMove,gearAction.transfertInitialSpeed);
                
                break;
            case (actionState.sustained,groundedType.IsOnGear):
               playerMove.GearSustainedMove(inputReader.horizontalMove);
               
               gearAction.TransferRotation(context.currentGear,gameObject,inputReader.horizontalMove,gearAction.transfertSustainSpeed);
